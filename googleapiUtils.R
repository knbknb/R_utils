...
attr(googleapi$kgapi_call_str, "help") <- "kgapi_call_str(): Return Knowledge Graph URL for a given query term, ready to use in a browser, or wget, etc."
...
attr(googleapi$kg_api_call, "help") <- "kgapi_call(): Perform Knowledge Graph Query. Param1: result from kgapi_call_str() call, return as a JSON object"
...
attr(googleapi$kgapi_call_data, "help") <- "kgapi_call_data(): Perform Knowledge Graph Query. Param1: result from kgapi_call_str() call, return as a JSON object"
...
attr(googleapi$kgapi_lookup, "help") <- "Perform a query on the Google Knowledge Graph API, return data as gathered /key-value form"
########################################
